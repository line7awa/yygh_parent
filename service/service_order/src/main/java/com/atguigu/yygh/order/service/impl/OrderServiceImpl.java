...
public class OrderServiceImpl  extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        System.out.println("sc:" + scheduleId);
        //获取就诊人信息
        Patient patient = patientFeignClient.getPatientOrder(patientId);

        //获取排班相关信息
        ScheduleOrderVo scheduleOrderVo = hospitalFeignClient.getScheduleOrderVo(scheduleId);
        System.out.println("sc2:" + scheduleOrderVo.toString());
        //判断当前时间是否还可以预约
        System.out.println("1" + new DateTime(scheduleOrderVo.getStartTime()));
        System.out.println("2" + new DateTime(scheduleOrderVo.getEndTime()));
        //0501：0：51暂时注销为通过测试
...
//        }
        ...
        System.out.println(signInfoVo.toString());
...
//        JSONObject result = HttpRequestHelper.sendRequest(paramMap, signInfoVo.getApiUrl() + "/order/submitOrder");
        ...
        if(result.getInteger("code")==200) {
            ...
            System.out.println("手机号码:"+orderInfo.getPatientPhone());
    ...
    public OrderInfo getOrder(String orderId) {
        ...
        System.out.println("PackOrderInfo:" + orderInfo);
        return this.packOrderInfo(orderInfo);
    }

    private OrderInfo packOrderInfo(OrderInfo orderInfo){
        orderInfo.getParam().put("orderStatusString",OrderStatusEnum.getStatusNameByStatus(
...
//        System.out.println(":::" + quitTime.toString());
//        System.out.println("::");
//

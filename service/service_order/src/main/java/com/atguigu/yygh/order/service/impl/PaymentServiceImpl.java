...
@Service
public class PaymentServiceImpl extends ServiceImpl<PaymentMapper, PaymentInfo>
    ...
    public void paySuccess(String out_trade_no, Map<String, String> resultMap) {
        ...
        JSONObject result = HttpRequestHelper.sendRequest(reqMap,"http://localhost:9998" +

...
import com.atguigu.yygh.common.helper.JwtHepler;
...
public class WeixinApiController {
    ...
    public String callback(String code,String state){
        ...
        //使用code和appid以及appscrecct换取access_token
        //$s占位符
        ...
        try{
            ...
            if (userInfo == null){
                //第三步拿着openid和access_token请求微信地址，得到扫描人信息
            ...
            String token = JwtHepler.createToken(userInfo.getId(),name);
            map.put("token",token);
            //跳转到前端页面
